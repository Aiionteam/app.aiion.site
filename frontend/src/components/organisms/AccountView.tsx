...
const getCommonStyles = (darkMode: boolean) => ({
  ...
  cardGradient: darkMode ? 'bg-gradient-to-br from-gray-700 to-gray-800 border-gray-600' : 'bg-gradient-to-br from-white to-[#f5f0e8] border-[#8B7355]',
  ...
  cardBg: darkMode ? 'bg-gray-700' : 'bg-[#f5f1e8]',
});
